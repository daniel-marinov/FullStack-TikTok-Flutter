...
class AuthController extends GetxController {
  ...
  //checking for user.value changes and displaying different screeens depending on the value
  @override
  void onReady() {
    super.onReady();
  ...
  void pickImage() async {
    ...
    if (pickedImage != null) {
      Get.snackbar('Profile Picture', 'You have selected your profile picture');
    }
  ...
  void registerUser(
    ...
    try {
      if (username.isNotEmpty &&
        ...
        Get.snackbar('Error Creating Account', "Enter all required fields");
      }
    } catch (e) {
  ...
  void loginUser(String email, String password) async {
    try {
      if (email.isNotEmpty && password.isNotEmpty) {
        ...
        Get.snackbar('Error Logging In', "Enter all required fields");
      }
    } catch (e) {
